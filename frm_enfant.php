...
?>
<h3><i class="fa fa-angle-right"></i> Saisie Enfant</h3>
...
<div class="row mt">
    <div class="col-lg-12">
        ...
        <div class="form-panel">
            ...
            <?php } ?>
            <form class="form-horizontal style-form" method="POST" action="add_enfant.php" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xl-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nom_enf">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="postnom_enf">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="prenom_enf">
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-xl-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" name="date_naiss_enf">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="controls col-md-8">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    ...
                                    <a href="advanced_form_components.html#" class="close fileupload-exists" data-dismiss="fileupload" style="float: none; margin-left:5px;"></a>
                                     <span>Type : jpg,jpeg,docx,pdf</span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
