...
$pdf->ln(5);
$txt = "M O U V E M E N T  D E S  A C T I F S  A G E N T S   P A R   S O C I E T E";
...
*/
    $header = array('N°','SOCIETE','MATRICULE','NOMS','DEBUT','FIN');
    // Data loading
    ...
    while($row = $result->fetch())
    {
        ...
        $code_sieg = $row['societe_ID'];
        $lib_sieg= $row['libelle_soc'];
