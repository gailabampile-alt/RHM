...
// Vérification
if (empty($periode) || empty($type_paie)) {
...
$sql_agents = $db->prepare("
    ...
    WHERE  detail_agent_siege.statut_ID='act' 
    ORDER BY t_siege.code_sieg, t_agent.nom_ag,t_agent.postnom_ag;
");
...
<body>
    ...
    BULLETIN DE PAIE MOIS DE  <?= formatPeriode($periode) ?>
            ...
            <div class="info">
                ...
                <b>Code Siège :</b> <?= h($agent['code_sieg'] ?? '') ?>
            </div>
