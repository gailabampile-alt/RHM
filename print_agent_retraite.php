...
class PDF extends FPDF
{
    ...
    function header_data($siege, $lib_siege)
    {
        ...
        $txt = "L I S T E    D E S    A G E N T S    RETRAITES    A    L A    D A T E    D U  ".date('d/m/Y');
...
$reqInfoAgent = $db->prepare("SELECT * FROM bdd_paie.v_agent_seiegact WHERE activiter_ID = '02' ORDER BY code_sieg;");
