    ...
    if(isset($date_paie)&& isset($type_paie)&& isset($periode)){
       ...
       $reqVerificationPaie -> bindValue(':type_paie',$type_paie);
        ...
        if($reqVerificationPaie ->rowCount() == 1){
            ...
            $reqAdd_Paie3 = $db->prepare('INSERT INTO bdd_paie.t_calcule_paie (Matricule, Nom, PostNom, prenom, N_inss, sexe, etat_civil, sit_famille, grade, EquiG, codeEiPaie, libelle_el_paie, montant_payer, periode) 
            select * from bdd_paie.v_diplome');
            $reqAdd_Paie3->execute();  
...
//  insert prime fidelité
            ...
            select * from bdd_paie.v_prime_fidel10f where periode=:periode');
            ...
            select * from bdd_paie.v_prime_fidel15f where periode=:periode');
            ...
            select * from bdd_paie.v_prime_fidel20f where periode=:periode');
            ...
            select * from bdd_paie.v_prime_fidel25f where periode=:periode');
            ...
            select * from bdd_paie.v_prime_fidel35f where periode=:periode');
            ...
            select * from bdd_paie.v_prime_fidel40f where periode=:periode');
...
// insert ipr
            ...
            select * from bdd_paie.v_ipr_all where periode=:periode');
             $reqAdd_Paie20->bindvalue(':periode',$periode);
            $reqAdd_Paie20->execute(); 

            
  //  insert   retenue syndic       
            $reqAdd_Paie = $db->prepare('INSERT INTO bdd_paie.t_retenue (Matricule, Nom, PostNom, prenom, N_inss, sexe, etat_civil, sit_famille, grade, EquiG, codeEiPaie, libelle_el_paie, montant_payer, periode) 
...
/// insert t_imposa
// insert onem
            $reqAdd_Paie = $db->prepare('INSERT INTO bdd_paie.t_imposa (Matricule, Nom, PostNom, prenom, N_inss, sexe, etat_civil, sit_famille, grade, EquiG, codeEiPaie, libelle_el_paie, montant_payer, periode) 
...
/// insert t_paie
            ...
            $reqAdd_Paie = $db->prepare('INSERT INTO bdd_paie.t_paie (Matricule, Nom, PostNom, prenom, N_inss, sexe, etat_civil, sit_famille, grade, EquiG, codeEiPaie, libelle_el_paie,montant_a_retenir , periode) 
            ...
            $reqAdd_Paie = $db->prepare('INSERT INTO bdd_paie.t_paie (Matricule, Nom, PostNom, prenom, N_inss, sexe, etat_civil, sit_famille, grade, EquiG, codeEiPaie, libelle_el_paie,montant_imposa, periode) 
  ...
  // update t_paie    
            ...
            $reqAdd_Paie = $db->prepare('UPDATE bdd_paie.t_paie JOIN bdd_paie.t_agent ON t_agent.matricule = t_paie.Matricule JOIN bdd_paie.detail_agent_siege ON detail_agent_siege.agent_ID=t_paie.Matricule JOIN bdd_paie.t_siege ON t_siege.code_sieg=detail_agent_siege.siege_ID 
            ...
            $reqAdd_Paie = $db->prepare("UPDATE bdd_paie.t_paie SET codeEiPaie ='232', libelle_el_paie ='IND. DE DEPLACEMENT' WHERE grade >=16 AND codeEiPaie ='231'");
           // $reqAdd_Paie->bindvalue(':periode',$periode);
            $reqAdd_Paie->execute();
