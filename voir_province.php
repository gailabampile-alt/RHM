...
<h3><i class="fa fa-angle-right"></i> Liste Des Provinces</h3>
        <div class="row mb">
          <!-- page start-->
          ...
          <?php } ?>
            ...
            <a href="accueil.php?page=Province" class="btn btn-round btn-primary col-sm-2" style="margin-bottom:25px;width:170px;"><i class="fa fa-plus-circle" style="margin-right: 7px;"></i> Ajouter </a>
            <a target="_blank" href="print_province.php" class="btn btn-round btn-primary col-sm-2" style="margin-bottom:25px;margin-left:15px;width:90px;"><i class="fa fa-print" style="margin-right: 7px;"></i> Liste</a>
              ...
              <table  cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  ...
                  <tr class="gradeC_">
                    <?php
                        $reqGetProvince = $db->prepare('SELECT * FROM bdd_paie.t_province');
                        $reqGetProvince ->execute();
                        while($resGetProvince=$reqGetProvince->fetch()){
                            $code_prov = $resGetProvince['code_prov'];
                    ...
                    ?>
                    <td> <?php echo $code_prov;?> </td>
                    <td> <?php echo $lib_prov;?></td>
                    <td>
                    <?php 
                    ...
                    <td class="hidden-phone">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="accueil.php?page=Edit_Province&code_prov=<?php echo $code_prov;?>" style="color:darkblue"> <i class="fa fa-edit" style="margin-right: 2px;"></i> Modifier</a></li>
                                <li class="divider"></li>
                                <li><a href="update_province.php?code_prov_act=<?php echo $code_prov;?>" style="color:green" > <i class="fa fa-check-circle" style="margin-right: 2px;"></i> Activer</a></li>
                                <li><a href="update_province.php?code_prov_desac=<?php echo $code_prov;?>" style="color:red"> <i class="fa fa-ban" style="margin-right: 2px;"></i> Désactiver</a></li>
                            </ul>
                        </div>
