...
<div class="row mt">
    <div class="col-lg-12">
        ...
        <div class="form-panel">
            ...
            <?php } ?>
            <form class="form-horizontal style-form" method="POST" action="update_conge.php" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xl-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" name="date_demande" value="<?php echo  $date_dem;?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="" class="form-control" name="excercice" value="<?php echo  $excercice;?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="nbrejrsol" id="Detailjrdem" value="<?php echo  $nbrejrdem;?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="nbrejrben" id="Detailbenef" onchange="calculEcart(this.value)" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Ecart</label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="ecart" id="DetailEcart" readonly>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <?php
                                    $reqGetNomUtilisateur = $db->prepare("SELECT * FROM bdd_paie.v_liste_utilisateur WHERE  id_user = :id_user");
                                    $reqGetNomUtilisateur->bindvalue(':id_user',$id_user);
                                    $reqGetNomUtilisateur->execute();
                                    while ($resGetNomUtilisateur = $reqGetNomUtilisateur->fetch()) {
                                        $nomComplet = $resGetNomUtilisateur['nom_ag'].' '.$resGetNomUtilisateur['postnom_ag'].' '.$resGetNomUtilisateur['prenom_ag'];
                                    }
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="datecreat" class="form-control" value="<?php echo $date_dem;?>" readonly>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-round btn-primary col-sm-3" id="addAgent"
                            name="auto_conge" style="margin-left:15px;width:150px;"><i class="fa fa-check"></i>Autorisé</button>
                            <!--a href="accueil.php?page=Voir_Enfant" class="btn btn-round btn-danger col-sm-3" style="margin-left:15px;width:150px;"><i class="fa fa-times"></i> Refusé</a-->
                            <button type="submit" name="refuse" formaction="refuse_conge.php?id=<?php echo $id_demande?>" class="btn btn-round btn-danger col-sm-3" style="margin-left:15px;width:150px;"><i class="fa fa-times"></i>Refusé</button>
