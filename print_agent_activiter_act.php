...
$pdf->ln(5);
$txt = "M O U V E M E N T  D E S  A G E N T S";
...
*/
    $header = array('N°','ACTIVITE','MATRICULE','NOMS','DEBUT','FIN');
    // Data loading
    ...
    WHERE ag.activiter_ID = '01' AND aga.statut_ID = 'act'");
    $result ->execute();
    $last_matric = NULL;
    $compt = 0;
    while($row = $result->fetch())
    {
        ...
        $code_sieg = $row['code_activ_ID'];
        $lib_sieg= $row['libelle_activ'];
