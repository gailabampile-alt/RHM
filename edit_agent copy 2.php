...
<div class="row mt">
    <div class="col-lg-12">
        ...
        <div class="form-panel">
            <form class="form-horizontal style-form" action="update_agent.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-xl-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo $nCNSS;?>" name="nCNSS" required>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-xl-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="tel" class="col-sm-3 form-control" name="phone" value="<?php echo $phone;?>">
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group">
                            <input type="submit" class="btn btn-round btn-primary col-sm-3" id="btnModifierAgent"
                             value="Modifier" name="updateAgent" style="margin-left:15px;width:150px;">
