...
<h3><i class="fa fa-angle-right"></i> Liste agents</h3>
            ...
            <form class="form-horizontal style-form" action="update_agent.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-xl-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo $numCompte;?>" name="nCompte">
                            </div>
                        </div>
                        <!--div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group">
                            <input type="submit" name="btn" formaction="index.php">
