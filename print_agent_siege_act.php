...
$pdf->ln(5);
$txt = "M O U V E M E N T  D E S  A C T I F S  A G E N T S   P A R  S I E G E";
...
*/
    $header = array('N°','SIEGE','MATRICULE','NOMS','DEBUT','FIN');
    // Data loading
    ...
    WHERE ags.statut_ID = 'act' AND ag.activiter_ID = '01' ORDER BY matricule");
    $result ->execute();
    $last_matric = NULL;
    $compt = 0;
