...
<div class="row mt">
    <div class="col-lg-12">
        ...
        <div class="form-panel">
            ...
            <?php } ?>
            <form class="form-horizontal style-form" method="POST" action="add_type_doc.php" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xl-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="lib_doc">
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-6">
                    <div class="form-group">
                        <button type="submit" class="btn btn-round btn-primary col-sm-3"  name="add_type_doc" style="margin-left:15px;width:150px;"><i class="fa fa-plus-circle"></i> Ajouter</button>
