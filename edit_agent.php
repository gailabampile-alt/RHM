<?php
    ...
    if(isset($_GET['matric'])){
        $matric = validation_donnees($_GET['matric']);
        $reqInfoAgent = $db->prepare('SELECT * FROM bdd_paie.v_info_agent WHERE matricule = :matricule');
        $reqInfoAgent ->bindValue(':matricule',$matric);
        $reqInfoAgent ->execute();
        while($resInfoAgent=$reqInfoAgent->fetch()){
            $matric = $resInfoAgent['matricule'];
            $nom = $resInfoAgent['nom_ag'];
            ...
            $phone = $resInfoAgent['phone'];
            $adresse = $resInfoAgent['adresse'];
...
<h3><i class="fa fa-angle-right"></i> Modification De l' Agent</h3>
<!-- BASIC FORM ELELEMNTS -->
<div class="row mt">
    <div class="col-lg-12">
        
        <div class="form-panel">
            <form id="formAgent" class="form-horizontal style-form" action="update_agent.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" value="<?php echo $prenom;?>" name="prenom" required>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" value="<?php echo $cod_naiss;?>" name="pNaiss">
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <select class="form-control chzn-select" name="nivEtud" required>
                                        ...
                                        <?php
                                            ...
                                            while($resGetNivEtude = $reqGetNivEtude->fetch()){
                                                ...
                                                $selected = ($nivEtude == $lib_niv || $nivEtude == $id_niv) ? 'selected' : '';
                                        ?>
                                            <option value="<?php echo $lib_niv;?>" <?php echo $selected;?>><?php echo $lib_niv;?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea type="text" class="form-control" rows="5" name="adress"><?php echo $adresse;?></textarea>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-xl-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" value="<?php echo $numCompte;?>" name="nCompte" required>
                                </div>
                            </div>
                             <div class="form-group">
                                    ...
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        ...
                                        <div>
                                            <span class="btn btn-theme03 btn-file">
                                                ...
                                                <input type="file" class="default" name="photo_ag"/>
                ...
                <div class="row" style="margin-top:20px;">
                    <div class="col-lg-12 text-center">
                        ...
                        <button type="button" class="btn btn-round btn-success" id="btnModifierAgent" onclick="confirmerModification()" style="display:none;">Modifier</button>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalConfirmationLabel">Confirmation de modification</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            Voulez-vous modifier les informations de l'agent : <strong><?php echo $matric.' / '.$nom.' '.$postnom.' '.$prenom;?></strong> ?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Annuler</button>
                            <button type="button" class="btn btn-primary" onclick="soumettreFormulaire()">Confirmer</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            function showStep(n) {
                ...
                if (n === steps.length - 1) {
                    ...
                    document.getElementById('btnModifierAgent').style.display = 'inline-block';
                } else {
                    document.getElementById('nextBtn').style.display = 'inline-block';
                    document.getElementById('btnModifierAgent').style.display = 'none';
                }
                refreshChosen(n);
            }

            function refreshChosen(n) {
                if (typeof $ !== 'undefined' && $.fn && $.fn.chosen) {
                    var step = document.getElementsByClassName('form-step')[n];
                    $(step).find('.chzn-select').each(function () {
