...
?>
<h3><i class="fa fa-angle-right"></i> Liste Des Grade</h3>
        <div class="row mb">
          <!-- page start-->
          ...
          <?php } ?>
            ...
            <a href="accueil.php?page=Grade" class="btn btn-round btn-primary col-sm-2" style="margin-bottom:25px;width:170px;"><i class="fa fa-plus-circle" style="margin-right: 7px;"></i> Ajouter </a>
            <a target="_blank" href="print_grade_ag.php" class="btn btn-round btn-primary col-sm-2" style="margin-bottom:25px;margin-left:15px;width:170px;"><i class="fa fa-print" style="margin-right: 7px;"></i>Imprimer</a>
              ...
              <table  cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th>Libellé</th>
                    <th>Equipe Paie</th>
                    <th class="hidden-phone">Equipe Comptable</th>
                    <th>Créer Par</th>
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    ?>
                    <td> <?php echo $code_grade;?> </td>
                    <td> <?php echo $lib_grade;?></td>
                    <td> <?php echo $eq_paie;?> </td>
                    <td> <?php echo $eq_compt;?></td>
                    <td> 
                      <?php 
                    ...
                    <td class="hidden-phone">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="accueil.php?page=Edit_Grade&code_gr=<?php echo $code_grade;?>" style="color:darkblue"> <i class="fa fa-edit" style="margin-right: 2px;"></i> Modifier</a></li>
                                <li class="divider"></li>
