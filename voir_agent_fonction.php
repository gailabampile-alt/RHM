...
<h3><i class="fa fa-angle-right"></i> Liste Des Agents / Fonction</h3>
        <div class="row mb">
          <!-- page start-->
          ...
          <?php } ?>
            ...
            <!--a target="_blank" href="print_agent_fonction_act.php" class="btn btn-round btn-primary col-sm-2" style="margin-bottom:25px;margin-left:15px;width:170px;"><i class="fa fa-print" style="margin-right: 7px;"></i>Imprimer</a>
                  ...
                  <tr class="gradeC_">
                    <?php
                        ...
                        while($resAgent_Siege=$reqAgent_Siege->fetch()){
                            ...
                            $code_fonc = $resAgent_Siege['fonction_ID'];
                            $lib_fonc = $resAgent_Siege['libelleFonct'];
                    ...
                    <td> <?php echo $noms;?> </td>
                    <td> <?php echo $code_fonc.' | '.$lib_fonc;?></td>
                    ...
                    <td class="hidden-phone">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a target="_blank" href="printMoveFonct.php?code=<?php echo $matric;?>" style="color:darkblue"> <i class="fa fa-print" style="margin-right: 2px;"></i> Imprimer</a></li>
                                <!--li class="divider"></li>
