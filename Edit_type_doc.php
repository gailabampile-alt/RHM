<?php
    ...
    if(isset($_GET['id'])){
        $id_typedoc = $_GET['id'];
        $req = $db->prepare('SELECT * FROM bdd_paie.t_type_doc WHERE id_typedoc = :id_typedoc');
        $req->bindValue(':id_typedoc',$id_typedoc);
        $req->execute();
        while ($res = $req->fetch()) {
            $id_typedoc = $res['id_typedoc'];
            $libelle_typedoc = $res['libelle_typedoc'];
...
<h3><i class="fa fa-angle-right"></i> TYPE DOCUMENT</h3>
...
<div class="row mt">
    <div class="col-lg-12">
        ...
        <div class="form-panel">
            ...
            <?php } ?>
            <form class="form-horizontal style-form" method="POST" action="update_type_doc.php" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xl-6">
                        
                        <div class="form-group">
                            <label class="col-sm-3 control-label">LIBELLE DOCUMENT</label>
                            <div class="col-sm-8">
                            <input type="hidden" class="form-control" name="id_typedoc" value="<?php echo $id_typedoc;?>">
                            <input type="text" class="form-control" name="lib_doc" value="<?php echo $libelle_typedoc; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-6">
                    <div class="form-group">
                        <button type="submit" class="btn btn-round btn-primary col-sm-3"  name="update_type_doc" style="margin-left:15px;width:150px;"><i class="fa fa-edit"></i>Modifier</button>
                            <a href="accueil.php?page=voir_type_doc" class="btn btn-round btn-warning col-sm-3" style="margin-left:15px;width:150px;"><i class="fa fa-list"></i> Mode Liste</a>
                    </div>
                    </div>
                </div>
            </form>
