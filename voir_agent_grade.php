...
<h3><i class="fa fa-angle-right"></i> Liste Des Agents / Grade</h3>
        <div class="row mb">
          <!-- page start-->
          ...
          <?php } ?>
            ...
            <!--<a target="_blank" href="print_agent_grade_act.php" class="btn btn-round btn-primary col-sm-2" style="margin-bottom:25px;margin-left:15px;width:170px;"><i class="fa fa-print" style="margin-right: 7px;"></i>Imprimer</a>
                ...
                <tbody>
                  ...
                  <tr class="gradeC_">
                    <?php
                        ...
                        agr.agent_ID,agr.grade_ID,agr.dateDebut,agr.dateFin,agr.statut_ID,agr.creerPar,agr.modifierPar,
                        CONCAT(ag.nom_ag,' ',ag.postnom_ag,' ',ag.prenom_ag) AS noms,ag.activiter_ID,
                        gr.libelle_grade
                        FROM bdd_paie.detail_agent_grade AS agr
                        INNER JOIN bdd_paie.t_agent AS ag ON agr.agent_ID = ag.matricule
                        INNER JOIN bdd_paie.t_grade AS gr ON agr.grade_ID = gr.code_grade
                        WHERE ag.activiter_ID = '01' AND agr.statut_ID = 'act' ");
                        $reqAgent_Siege ->execute();
                        while($resAgent_Siege=$reqAgent_Siege->fetch()){
                            $matric = $resAgent_Siege['agent_ID'];
                            $noms = $resAgent_Siege['noms'];
                            $code_gr = $resAgent_Siege['grade_ID'];
                            $lib_gr = $resAgent_Siege['libelle_grade'];
                    ...
                    <td class="hidden-phone">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a target="_blank" href="printMoveGrade.php?code=<?php echo  $matric;?>" style="color:darkblue"> <i class="fa fa-print" style="margin-right: 2px;"></i> Imprimer</a></li>
                                <!--li class="divider"></li>
