...
$pdf->ln(5);
$txt = "M O U V E M E N T  D E S  A C T I F S  A G E N T S   P A R   G R A D E";
...
*/
    $header = array('N°','GRADE','MATRICULE','NOMS','DEBUT','FIN');
    // Data loading
    ...
    while($row = $result->fetch())
    {
        ...
        $code_sieg = $row['grade_ID'];
        $lib_sieg= $row['libelle_grade'];
