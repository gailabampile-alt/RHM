...
<h3><i class="fa fa-angle-right"></i> Liste Des Agents / Société</h3>
        <div class="row mb">
          <!-- page start-->
          ...
          <?php } ?>
           ...
           <!-- <a target="_blank" href="print_agent_societe_act.php" class="btn btn-round btn-primary col-sm-2" style="margin-bottom:25px;margin-left:15px;width:170px;"><i class="fa fa-print" style="margin-right: 7px;"></i>Imprimer</a>
              ...
              <table  cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  ...
                  <tr class="gradeC_">
                    ...
                    <td> <?php echo $noms;?> </td>
                    <td> <?php echo $code_soc.' | '.$lib_soc;?></td>
                    ...
                    <td class="hidden-phone">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a target="_blank" href="printMoveSociet.php?code=<?php echo $matric;?>" style="color:darkblue"> <i class="fa fa-print" style="margin-right: 2px;"></i> Imprimer</a></li>
                                <!--li class="divider"></li>
