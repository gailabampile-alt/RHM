...
class PDF extends FPDF
{
    ...
    {
        $widths = [15, 35, 120]; // N°, Code, Libellé
...
$titre = "LISTE DE FONCTION — EN DATE DU " . date('d-m-Y');
...
$reqFonction = $db->prepare(
    'SELECT codeFonct, libelleFonct FROM bdd_paie.t_fonction'
);
$reqFonction->execute();
...
$pdf->SetTextColor(0,0,80);
$pdf->Cell(0, 8, 'Total : ' . count($data) . ' fonctions', 0, 1, 'R');
