...
// ======================================================================
//   RÉCUPÉRATION DES DONNÉES CNSS (408) POUR TOUS LES SIÈGES
// ======================================================================
$sql = "
    SELECT 
        p.Matricule,
...
foreach ($group as $code_siege => $content)
{
    ...
    $titre = "RETENU CNSS — SIEGE : $code_siege / $lib_sieg — PERIODE : $periode";
    ...
    $txtTotal = "TOTAL CNSS RETENU — SIEGE $code_siege : ".
