...
$pdf->ln(5);
$txt = "M O U V E M E N T  D E S  A C T I F S  A G E N T S   P A R   S Y N D I C A T";
...
*/
    $header = array('N°','SYNDICAT','MATRICULE','NOMS','DEBUT','FIN');
    // Data loading
    ...
    while($row = $result->fetch())
    {
        ...
        $code_sieg = $row['syndicat_ID'];
        $lib_sieg= $row['libelle_syndi'];
