...
<h3><i class="fa fa-angle-right"></i> Liste Des Agents / Siège</h3>
        <div class="row mb">
          <!-- page start-->
          ...
          <?php } ?>
           ...
           <!-- <a target="_blank" href="print_agent_siege_act.php" class="btn btn-round btn-primary col-sm-2" style="margin-bottom:25px;margin-left:15px;width:170px;"><i class="fa fa-print" style="margin-right: 7px;"></i>Imprimer</a>
              ...
              <table  cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th>NOMS</th>
                    <th>SIEGE</th>
                    <th class="hidden-phone">TYPE SIEGE</th>
                    <th>DATE DEBUT</th>
                    <th>CREER PAR</th>
                ...
                <tbody>
                  ...
                  <tr class="gradeC_">
                    <?php
                        ...
                        ag.matricule, CONCAT(ag.nom_ag, ' ', ag.postnom_ag, ' ', ag.prenom_ag) AS nom,
                        ags.siege_ID, ags.dateDebut, ags.dateFin, ags.creerPar, ags.modifierPar,ags.statut_ID,
                        sg.libelle_sieg, sg.typeSiege_ID,
                        tsg.libelle_typSieg
                        FROM bdd_paie.detail_agent_siege AS ags
                        INNER JOIN bdd_paie.t_agent AS ag ON ags.agent_ID = ag.matricule
                        INNER JOIN bdd_paie.t_siege AS sg ON ags.siege_ID = sg.code_sieg
                        INNER JOIN bdd_paie.t_type_siege AS tsg ON sg.typeSiege_ID = tsg.code_typSieg
                        WHERE ags.statut_ID = 'act' ");
                        $reqAgent_Siege ->execute();
                        while($resAgent_Siege=$reqAgent_Siege->fetch()){
                            $matric = $resAgent_Siege['matricule'];
                            $noms = $resAgent_Siege['nom'];
                            $code_sieg = $resAgent_Siege['siege_ID'];
                            $lib_sieg = $resAgent_Siege['libelle_sieg'];
                            $dateDebut = $resAgent_Siege['dateDebut'];
                            $dateFin = $resAgent_Siege['dateFin'];
                            $typ_sieg = $resAgent_Siege['typeSiege_ID'];
                            $lib_typ_sieg = $resAgent_Siege['libelle_typSieg'];
                    ...
                    <td> <?php echo $noms;?> </td>
                    <td> <?php echo $code_sieg.' | '.$lib_sieg;?></td>
                    <td> <?php echo $lib_typ_sieg;?> </td>
                    ...
                    <td class="hidden-phone">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a target="_blank" href="printMoveSiege.php?code=<?php echo $matric;?>" style="color:darkblue"> <i class="fa fa-print" style="margin-right: 2px;"></i>Mouvement</a></li>
                                  <li><a target="_blank" href="printMoveCarriere.php?code=<?php echo $matric;?>" style="color:darkblue"> <i class="fa fa-print" style="margin-right: 2px;"></i> Carrière</a></li>
                                <!--li class="divider"></li>
