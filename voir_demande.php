...
<h3><i class="fa fa-angle-right"></i> Liste Des Congé demandés</h3>
        <div class="row mb">
          <!-- page start-->
          ...
          <?php } ?>
            ...
            <a href="accueil.php?page=Demande_Conger" class="btn btn-round btn-primary col-sm-2" style="margin-bottom:25px;width:130px;"><i class="fa fa-plus-circle" style="margin-right: 7px;"></i> Ajouter </a>
            <a target="_blank" href="print_liste_demande_conge.php" class="btn btn-round btn-primary col-sm-2" style="margin-bottom:25px;margin-left:15px;width:90px;"><i class="fa fa-print" style="margin-right: 7px;"></i> Liste</a>
              ...
              <table  cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    <td><a target="_blank" href="print_decision_conger.php?matric=<?php echo $matricule;?>&idc=<?php echo $id_dem_conge; ?>"> <i class="fa fa-print fa-lg" style="margin-right: 5px; color:green;width: 25px"></i> </a></td>
