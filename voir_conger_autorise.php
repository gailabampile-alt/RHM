...
<h3><i class="fa fa-angle-right"></i> Liste De Congés autorisés</h3>
        <div class="row mb">
          <!-- page start-->
          ...
          <?php } ?>
            ...
            <a target="_blank" href="#" class="btn btn-round btn-primary col-sm-2" style="margin-bottom:25px;margin-left:15px;width:90px;"><i class="fa fa-print" style="margin-right: 7px;"></i> Liste</a>
            <a href="accueil.php?page=Calendrier_Conges&statut=auto" class="btn btn-round btn-success col-sm-2" style="margin-bottom:25px;margin-left:15px;width:130px;"><i class="fa fa-calendar" style="margin-right: 7px;"></i> Calendrier</a>
            <!--a href="#" download ="rpt_grade" class="btn btn-round btn-primary col-sm-2" style="margin-bottom:25px;margin-left:15px;width:70px;"><i class="fa fa-download" style="margin-right: 7px;"></i>PDF</a-->
              ...
              <table  cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  ...
                  <tr class="gradeC">
                  <?php
                        $reqGrade = $db->prepare('SELECT * FROM bdd_paie.t_demandeconge INNER JOIN bdd_paie.t_typconge ON t_typconge.id_type_conge=t_demandeconge.id_typeconge INNER JOIN bdd_paie.t_agent ON t_agent.matricule=t_demandeconge.matricule WHERE t_demandeconge.statut =:statut and etat=:etat');
