...
<h3><i class="fa fa-angle-right"></i> Liste Des Roles</h3>
        <div class="row mb">
          <!-- page start-->
          ...
          <?php } ?>
            ...
            <a href="accueil.php?page=Frm_roleUser" class="btn btn-round btn-primary col-sm-2" style="margin-bottom:25px;width:170px;"><i class="fa fa-plus-circle" style="margin-right: 7px;"></i> Ajouter </a>
            <!--a href="print_carburant.php" target="_blank" class="btn btn-round btn-primary col-sm-2" style="margin-bottom:25px;margin-left:15px;width:170px;"><i class="fa fa-print" style="margin-right: 7px;"></i>Imprimer La Liste</a-->
              ...
              <table  cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  ...
                  <tr class="gradeC_">
                    <?php
                        $reqRole = $db->prepare('SELECT * FROM bdd_paie.t_role_user');
                        $reqRole ->execute();
                        while($resRole=$reqRole->fetch()){
                    ...
                    <td > 
                    <?php 
                        if($modifierPar == "sysAdmin" || empty($modifierPar)){
                          echo $modifierPar ?: "sysAdmin";
                        }else{
                          $nomModifier = "";
                          $reqGetInfoUser = $db->prepare('SELECT nom_ag,postnom_ag,prenom_ag FROM bdd_paie.v_liste_utilisateur 
                          ...
                          while ($resGetInfoUser = $reqGetInfoUser->fetch()) {
                            $nom_postnom = $resGetInfoUser['nom_ag'].' '.$resGetInfoUser['postnom_ag'];
                            $prenom = ucfirst(strtolower($resGetInfoUser['prenom_ag']));
                            $nomModifier = $nom_postnom.' '.$prenom;
                          }
                          echo $nomModifier ?: $modifierPar;
                        }
                    ...
                    <td class="hidden-phone">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="accueil.php?page=Edit_roleUser&codRole=<?php echo $id_role;?>" style="color:darkblue"> <i class="fa fa-edit" style="margin-right: 2px;"></i> Modifier</a></li>
                                <li class="divider"></li>
                                <li><a href="update_roleUser.php?code_role_act=<?php echo $id_role;?>" style="color:green" > <i class="fa fa-check-circle" style="margin-right: 2px;"></i> Activer</a></li>
                                <li><a href="update_roleUser.php?code_role_desac=<?php echo $id_role;?>" style="color:red"> <i class="fa fa-ban" style="margin-right: 2px;"></i> Désactiver</a></li>
                            </ul>
                        </div>
                        <!-- Single button -->
                    </td>
